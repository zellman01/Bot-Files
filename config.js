...
exports.nick = 'Minaxet';

exports.pass = 'BotUser001';
...
exports.rooms = ['Lobby', 'Help', 'Tournaments', 'League vs League', 'Development'];
...
exports.initCmds = ['|/avatar 60']; // Other commands (avatar, blockchallenges, etc)
...
exports.pmhelp = "Hi #USER! I am a robot, please PM Somebody that is a %, @, # or ~ if you need help. Please do not PM this robot again. Command guide: https://github.com/Ecuacion/Pokemon-Showdown-Node-Bot/blob/master/commands/README.md";
...
exports.initBattleMsg = ['gl hf', 'hf lsg'];
...
exports.ladderNumberOfBattles = 2;
